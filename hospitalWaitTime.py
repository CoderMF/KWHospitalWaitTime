...
SMH_url = 'https://smgh-predict.oculys.com/'
...
def scraper (url,arrival,patients,date):
    ...
    # Parse the HTML content of the page
        ...
        wait_time = soup.find('div', id=arrival)
...
#json_scraper (GRH_json_url,'arrival-to-md','patients-waiting','date-created')
scraper (SMH_url,'mainStopwatch','currentPatients','stdStopwatchBottomText')